...
function sanitizeSettings(raw: any): BotSettings {
    ...
    return {
        ...
        enableRunnerMode: bool(raw.enableRunnerMode, false),
        runnerMinScore: num(raw.runnerMinScore, 55, 0, 100),
        runnerMin5mToLiquidityPct: num(raw.runnerMin5mToLiquidityPct, 18, 0, 1000),
        runnerMin5mTo1hPct: num(raw.runnerMin5mTo1hPct, 35, 0, 1000),
        runnerMinPriceChangePct: num(raw.runnerMinPriceChangePct, 0, -100, 10000),
        runnerMinLiquidityChangePct: num(raw.runnerMinLiquidityChangePct, 0, -100, 10000),
        runnerMinPairAgeMinutes: num(raw.runnerMinPairAgeMinutes, 2, 0, 1440),
        runnerTopCandidates: num(raw.runnerTopCandidates, 3, 1, 20),
